...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $cek = mysqli_query($koneksi, "SELECT * FROM ti2b_portofolio WHERE id_portofolio = '$id_portofolio'");
    ...
    // Query tambah data
    $query = "INSERT INTO ti2b_portofolio (id_portofolio, nama_kegiatan, waktu_kegiatan) VALUES ('$id_portofolio', '$nama_kegiatan', '$waktu_kegiatan')";
